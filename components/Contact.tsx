      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a 
              href="mailto:jaiswalarpita222@gmail.com"
          ...
          <div className="pt-8 border-t border-white/10">
            ...
            <div className="flex gap-6 text-2xl text-gray-400">
              {[
                ...
                { icon: FaTwitter, href: '#', color: 'hover:text-[#1DA1F2] hover:drop-shadow-[0_0_10px_#1DA1F2]' },
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.href}
        ...
        >
          <form className="bg-glass-bg backdrop-blur-xl border border-glass-border shadow-glass rounded-2xl p-6 md:p-8 space-y-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white font-body focus:outline-none focus:border-secondary/50 focus:bg-white/5 transition-all placeholder:text-gray-600"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white font-body focus:outline-none focus:border-secondary/50 focus:bg-white/5 transition-all placeholder:text-gray-600 resize-none"
              ></textarea>
            </div>

            <button 
              type="button"
              className="w-full py-4 rounded-xl bg-secondary/10 text-secondary border border-secondary/30 hover:bg-secondary/20 hover:shadow-neon-blue font-heading font-bold tracking-wide transition-all duration-300 uppercase text-sm flex items-center justify-center gap-2 group"
            >
